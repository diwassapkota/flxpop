 ...
 *
 * <p>Origins are configurable via {@code flexpop.cors.allowed-origin-patterns}
 * (env: {@code FLEXPOP_CORS_ALLOWED_ORIGIN_PATTERNS}, comma-separated). The
...
public class CorsConfig implements WebMvcConfigurer {
    ...
    public CorsConfig(
            @Value("${flexpop.cors.allowed-origin-patterns}") List<String> allowedOriginPatterns) {

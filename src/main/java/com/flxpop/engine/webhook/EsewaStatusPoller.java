...
import com.flxpop.engine.adapter.esewa.EsewaAdapter;
...
public class EsewaStatusPoller {
    ...
    @Scheduled(
            fixedDelayString   = "${flxpop.gateways.esewa.poll-interval-ms:5000}",
            initialDelayString = "${flxpop.gateways.esewa.poll-initial-delay-ms:4000}"
    )
    public void tick() {

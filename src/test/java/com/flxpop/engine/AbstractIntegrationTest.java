 ...
 *
 *   - Talks to the local MySQL `flxpop_test` schema (no Docker required).
 ...
 *     {@code flxpop.gateways.fonepay.base-url}. Default stubs echo the
...
public abstract class AbstractIntegrationTest {
    ...
    public static final String DEV_KEY = "sk_dev_local_FLXPOPDEVKEY1234567890";
    /** Known dev publishable key seeded by V4__seed_dev_publishable_key.sql */
    public static final String DEV_PK  = "pk_dev_local_FLXPOPPUBLICKEY1234567890";
    ...
    private static void bootstrapTestDatabase() {
        try {
            ...
            String db   = env("TEST_DB_NAME", "flxpop_test");
    ...
    static void fonepayProps(DynamicPropertyRegistry r) {
        r.add("flxpop.gateways.fonepay.base-url",                 FONEPAY_MOCK::baseUrl);
        r.add("flxpop.gateways.fonepay.private-key-base64-pkcs8", () -> FONEPAY_PRIVATE_KEY_B64);
        r.add("flxpop.gateways.fonepay.terminal-id",              () -> "TEST-TERMINAL-001");
        r.add("flxpop.gateways.fonepay.login-username",           () -> "test-user");
        r.add("flxpop.gateways.fonepay.login-password",           () -> "test-pass");
        r.add("flxpop.gateways.fonepay.webhook-secret",           () -> DEV_FONEPAY_WEBHOOK_SECRET);
    }
